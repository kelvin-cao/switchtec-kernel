...
static const struct event_reg {
	...
	enum {
		GEN3_PNX_MR4	= BIT(SWITCHTEC_EVLIST_VER_GEN3_PFX_PSX_MR4),
		GEN3_PAX	= BIT(SWITCHTEC_EVLIST_VER_GEN3_PAX),
		ALL_GEN3	= GEN3_PNX_MR4 | GEN3_PAX,
	} ver_mask;
} event_regs[] = {
	EV_GLB(SWITCHTEC_IOCTL_EVENT_STACK_ERROR, stack_error_event_hdr,
	       ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_PPU_ERROR, ppu_error_event_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_ISP_ERROR, isp_error_event_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_SYS_RESET, sys_reset_event_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_FW_EXC, fw_exception_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_FW_NMI, fw_nmi_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_FW_NON_FATAL, fw_non_fatal_hdr,
	       ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_FW_FATAL, fw_fatal_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_TWI_MRPC_COMP, twi_mrpc_comp_hdr,
	       ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_TWI_MRPC_COMP_ASYNC,
	       twi_mrpc_comp_async_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_CLI_MRPC_COMP, cli_mrpc_comp_hdr,
	       ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_CLI_MRPC_COMP_ASYNC,
	       cli_mrpc_comp_async_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_GPIO_INT, gpio_interrupt_hdr, ALL_GEN3),
	EV_GLB(SWITCHTEC_IOCTL_EVENT_GFMS, gfms_event_hdr, GEN3_PAX),
	EV_PAR(SWITCHTEC_IOCTL_EVENT_PART_RESET, part_reset_hdr, ALL_GEN3),
	EV_PAR(SWITCHTEC_IOCTL_EVENT_MRPC_COMP, mrpc_comp_hdr, ALL_GEN3),
	...
	EV_PAR(SWITCHTEC_IOCTL_EVENT_INTERCOMM_REQ_NOTIFY, intercomm_notify_hdr,
	       GEN3_PAX),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_AER_IN_P2P, aer_in_p2p_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_AER_IN_VEP, aer_in_vep_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_DPC, dpc_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_CTS, cts_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_HOTPLUG, hotplug_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_IER, ier_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_THRESH, threshold_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_POWER_MGMT, power_mgmt_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_TLP_THROTTLING, tlp_throttling_hdr,
	       ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_FORCE_SPEED, force_speed_hdr, ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_CREDIT_TIMEOUT, credit_timeout_hdr,
	       ALL_GEN3),
	EV_PFF(SWITCHTEC_IOCTL_EVENT_LINK_STATE, link_state_hdr, ALL_GEN3),
};
...
static int event_supported(struct switchtec_dev *stdev, int eid, int idx)
{
	...
	if (stdev->gen == SWITCHTEC_GEN3) {
		if (event_regs[eid].ver_mask &
		    BIT(stdev->evlist_ver))
			return 1;
	} else if (stdev->gen == SWITCHTEC_GEN4) {
...
static int mask_event(struct switchtec_dev *stdev, int eid, int idx)
{
	...
	if (!event_supported(stdev, eid, idx))
		return 0;
			       ...
			       const struct pci_device_id *id)
{
	...
	stdev->gen = id->driver_data >> 16;
	stdev->var = id->driver_data && 0xffff;
...
#define SWITCHTEC_PCI_DEVICE(device_id, gen, variant) \
	{ \
...
static const struct pci_device_id switchtec_pci_tbl[] = {
	SWITCHTEC_PCI_DEVICE(0x8531, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFX 24xG3
	SWITCHTEC_PCI_DEVICE(0x8532, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFX 32xG3
	SWITCHTEC_PCI_DEVICE(0x8533, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFX 48xG3
	SWITCHTEC_PCI_DEVICE(0x8534, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFX 64xG3
	SWITCHTEC_PCI_DEVICE(0x8535, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFX 80xG3
	SWITCHTEC_PCI_DEVICE(0x8536, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFX 96xG3
	SWITCHTEC_PCI_DEVICE(0x8541, SWITCHTEC_GEN3, SWITCHTEC_PSX),//PSX 24xG3
	SWITCHTEC_PCI_DEVICE(0x8542, SWITCHTEC_GEN3, SWITCHTEC_PSX),//PSX 32xG3
	SWITCHTEC_PCI_DEVICE(0x8543, SWITCHTEC_GEN3, SWITCHTEC_PSX),//PSX 48xG3
	SWITCHTEC_PCI_DEVICE(0x8544, SWITCHTEC_GEN3, SWITCHTEC_PSX),//PSX 64xG3
	SWITCHTEC_PCI_DEVICE(0x8545, SWITCHTEC_GEN3, SWITCHTEC_PSX),//PSX 80xG3
	SWITCHTEC_PCI_DEVICE(0x8546, SWITCHTEC_GEN3, SWITCHTEC_PSX),//PSX 96xG3
	SWITCHTEC_PCI_DEVICE(0x8551, SWITCHTEC_GEN3, SWITCHTEC_PAX),//PAX 24XG3
	SWITCHTEC_PCI_DEVICE(0x8552, SWITCHTEC_GEN3, SWITCHTEC_PAX),//PAX 32XG3
	SWITCHTEC_PCI_DEVICE(0x8553, SWITCHTEC_GEN3, SWITCHTEC_PAX),//PAX 48XG3
	SWITCHTEC_PCI_DEVICE(0x8554, SWITCHTEC_GEN3, SWITCHTEC_PAX),//PAX 64XG3
	SWITCHTEC_PCI_DEVICE(0x8555, SWITCHTEC_GEN3, SWITCHTEC_PAX),//PAX 80XG3
	SWITCHTEC_PCI_DEVICE(0x8556, SWITCHTEC_GEN3, SWITCHTEC_PAX),//PAX 96XG3
	SWITCHTEC_PCI_DEVICE(0x8561, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXL 24XG3
	SWITCHTEC_PCI_DEVICE(0x8562, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXL 32XG3
	SWITCHTEC_PCI_DEVICE(0x8563, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXL 48XG3
	SWITCHTEC_PCI_DEVICE(0x8564, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXL 64XG3
	SWITCHTEC_PCI_DEVICE(0x8565, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXL 80XG3
	SWITCHTEC_PCI_DEVICE(0x8566, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXL 96XG3
	SWITCHTEC_PCI_DEVICE(0x8571, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXI 24XG3
	SWITCHTEC_PCI_DEVICE(0x8572, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXI 32XG3
	SWITCHTEC_PCI_DEVICE(0x8573, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXI 48XG3
	SWITCHTEC_PCI_DEVICE(0x8574, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXI 64XG3
	SWITCHTEC_PCI_DEVICE(0x8575, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXI 80XG3
	SWITCHTEC_PCI_DEVICE(0x8576, SWITCHTEC_GEN3, SWITCHTEC_PFX),//PFXI 96XG3
	SWITCHTEC_PCI_DEVICE(0x4000, SWITCHTEC_GEN4, SWITCHTEC_PFX),//PFXI 100XG4
	SWITCHTEC_PCI_DEVICE(0x4084, SWITCHTEC_GEN4, SWITCHTEC_PFX),//PFXI 84XG4
	SWITCHTEC_PCI_DEVICE(0x4068, SWITCHTEC_GEN4, SWITCHTEC_PFX),//PFXI 68XG4
	SWITCHTEC_PCI_DEVICE(0x4052, SWITCHTEC_GEN4, SWITCHTEC_PFX),//PFXI 52XG4
	SWITCHTEC_PCI_DEVICE(0x4036, SWITCHTEC_GEN4, SWITCHTEC_PFX),//PFXI 36XG4
	SWITCHTEC_PCI_DEVICE(0x4028, SWITCHTEC_GEN4, SWITCHTEC_PFX),//PFXI 28XG4
	SWITCHTEC_PCI_DEVICE(0x4100, SWITCHTEC_GEN4, SWITCHTEC_PSX),//PSXI 100XG4
	SWITCHTEC_PCI_DEVICE(0x4184, SWITCHTEC_GEN4, SWITCHTEC_PSX),//PSXI 84XG4
	SWITCHTEC_PCI_DEVICE(0x4168, SWITCHTEC_GEN4, SWITCHTEC_PSX),//PSXI 68XG4
	SWITCHTEC_PCI_DEVICE(0x4152, SWITCHTEC_GEN4, SWITCHTEC_PSX),//PSXI 52XG4
	SWITCHTEC_PCI_DEVICE(0x4136, SWITCHTEC_GEN4, SWITCHTEC_PSX),//PSXI 36XG4
	SWITCHTEC_PCI_DEVICE(0x4128, SWITCHTEC_GEN4, SWITCHTEC_PSX),//PSXI 28XG4
	{0}
};
